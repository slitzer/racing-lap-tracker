<div style="display: flex; flex-wrap: wrap; gap: 2rem; align-items: flex-start;">
  ...
  <div style="flex: 0 0 650px; max-width: 100%;">
    <img src="/GamePack/cars/cars/metalmoro_ajr_chevy/image_1.jpg" alt="MetalMoro AJR Chevy" style="width: 100%; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);" />
  </div>
...
<table style="width: 100%; border-collapse: collapse;">
  <tbody>
<tr>
      <td style="padding-right: 1rem;"><b>Power</b></td><td>443 kW 594 hp</td>
      <td style="width: 1px; background-color: #555;"></td>
      <td style="padding-left: 1rem;"><b>Torque</b></td><td>700 Nm 516 ft/lb</td>
    </tr>
    <tr>
      <td style="padding-right: 1rem;"><b>Weight</b></td><td>960 kg 2117 lb</td>
      <td style="width: 1px; background-color: #555;"></td>
      <td style="padding-left: 1rem;"><b>Power to Weight</b></td><td>0.619</td>
    </tr>
    <tr>
      <td style="padding-right: 1rem;"><b>Engine</b></td><td>6.2 & 6.9 L - LS3 - NA</td>
      <td style="width: 1px; background-color: #555;"></td>
...
<img src="/GamePack/cars/cars/metalmoro_ajr_chevy/image_1.jpg" style="width: 100%; border-radius: 8px;" />
